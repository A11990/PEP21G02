...
class Test1:
  ...
  def add_start_time(self, start_time_list):
    start_time_list.append(self)


  def add_worker(self, name_list):
    name_list.append(self)

  # Create method to add worker end time
  def add_end_time(self, end_time_list):
    end_time_list.append(self)
...
try:
  Test1.add_end_time("16:01:20")
except WorkEndError:
  pass


Test1.add_worker("Ana")
try:
  Test1.add_start_time("09:03:15")
except WorkStartError:
  pass

try:
  Test1.add_end_time("18:04:15")
except WorkEndError:
  pass


Test1.add_worker("Tim")
try:
  Test1.add_start_time("09:04:25")
except WorkStartError:
  pass

try:
  Test1.add_end_time("18:05:25")
except WorkEndError:
  pass
...
Test1.add_worker("Tim")
try:
  Test1.add_start_time("09:04:30")
except WorkStartError:
  pass

try:
  Test1.add_end_time("18:05:30")
except WorkEndError:
  pass

f = open("Test.txt", "w")

f.write(name_list,start_time_list,end_time_list)
